        ...
        function handleSwatchClick(e) {
            ...
            if (activeSwatchIndex === clickedIndex) {
                // Deselect if clicking the same swatch
            ...
            // Set color dropper cursor
            imageContainer.style.cursor = 'none';
            setTimeout(() => {
                imageContainer.style.cursor = 'url("Color-Dropper.png") 0 24, crosshair';
            }, 50);
        ...
        function handleDocumentClick(e) {
            // If click is outside swatch and image container, deselect active swatch
